<template>
    <div id="app">
        <div class="tabs-container">
            ...
            <button @click="goToPage('/plan')" class="tab-button">菜单规划</button>
            <button @click="goToPage('/review')" class="tab-button">采购清单</button>
            <button @click="goToPage('/menu')" class="tab-button">菜谱管理</button>
            <button @click="goToPage('/ingredientManagement')" class="tab-button">原料管理</button>
        </div>
...
<style scoped>
    ...
    .tabs-container {
        ...
        align-items: center;
        height: 60px; /* Height for the tabs section */
    ...
    .tab-button {
        ...
        color: white;
        border-right: 1px solid #fff; /* Add a border between the buttons */
        text-align: center;
        flex: 1; /* Spread the buttons evenly */
    }
    ...
    /* Add some space for the content below the tabs */
    router-view {
        flex: 1;
        padding: 20px;
    }
